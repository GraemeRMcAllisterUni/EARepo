package gppDemos.mandelbrot.data

//import gppDemos.mandelbrot.cluster.SerializedMandelbrotPixel
import gppDemos.mandelbrot.cluster.*

class MandelbrotPixel  extends gppLibrary.DataClass {
  int px, py, colour = -1
  double x, y
