...
//usage runDemo nQueensProblem\TestQueensTournament resultsFile N clients initialPopulation
...
print """Queens Trnmnt, $crossoverProb, $mutateProb, $tournamentSize, $N, $clients, $initialPopulation, , """
